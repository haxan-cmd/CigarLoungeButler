...
MOST_LETHAL_ROLE_ID     = 1535424970816094238
...
# Server map rotation (TO), in play order. Reference data (names match
# MAP_FACTIONS keys). Not wired to a live feature: submission-time session
# analysis proved unreliable because people only submit NOTABLE games, so
# upload gaps are not play gaps. Kept for a future roster-overlap approach.
MAP_ROTATION = [
...
MASTERY_WEAPON_EMOJIS = {
    ...
    "Heavy Mace": "<a:heavymacemastery:1544835677286309958>",
}
...
TITLE_EMOJIS = {
    ...
    "Dominance":       "<a:dominance:1535424879711752233>",
...
LEADERBOARD_NAME_OVERRIDES = {
    ...
    "833823649676394516": "Massive Σggplant",  # Massive Eggplant (real submission id)
}
